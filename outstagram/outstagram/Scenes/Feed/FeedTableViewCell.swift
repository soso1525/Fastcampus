...
final class FeedTableViewCell: UITableViewCell {
    ...
    func setup() {
        [postImageView, 
         likeButton, commentButton, directMessageButton, bookmarkButton, currentLikedCountLabel, contentsLabel, dateLabel]
        ...
        postImageView.snp.makeConstraints {
            ...
            $0.height.equalTo(postImageView.snp.width) // 1:1
        }
